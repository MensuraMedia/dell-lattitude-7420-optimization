...
| [scripts/](scripts/) | Diagnostics collector, guarded build script, post-install repair, backlight handoff, gaming baseline harness, gaming handoff report, aggressive cooling control, thermal decay test, camera diagnostics, lid/dock handoff, display-utility |
